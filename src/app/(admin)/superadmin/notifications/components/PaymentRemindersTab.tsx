...
const ScheduleReminderModal = ({
  ...
  const { control, handleSubmit, register, reset, formState: { errors, isSubmitting } } = useForm<ScheduledReminderFormData>({
        ...
        <DialogContent className="max-w-3xl">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                <Controller
                    ...
                    control={control}
                    render={({ field }) => (
                         <Select onValueChange={field.onChange} value={field.value} disabled={!!existingSchedule}>
