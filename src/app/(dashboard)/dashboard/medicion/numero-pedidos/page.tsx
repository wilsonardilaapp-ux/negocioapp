...
import { ShoppingBag, TrendingUp, TrendingDown, Loader2 } from 'lucide-react';
import { cn } from '@/lib/utils';

/**
 * @fileOverview Vista de análisis para el número de pedidos.
 */
export default function NumeroPedidosPage() {
