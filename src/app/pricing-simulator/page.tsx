        ...
        <CardHeader className="bg-slate-50/50 border-b py-8 px-8">
           <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <CardTitle className="text-2xl font-black uppercase tracking-tight">Variables de Operación</CardTitle>
                  <CardDescription className="font-bold text-slate-500 uppercase text-[10px] tracking-widest">
                    Ajusta los parámetros para encontrar tu plan ideal.
                  </CardDescription>
                </div>
              </div>
          ...
          return (
            ...
            >
              <Card className={cn(
                ...
                isWinner ? "border-orange-500 shadow-2xl scale-[1.03] z-10 bg-white" : "border-slate-100 hover:border-primary/10 bg-white/80",
                isBlocked && "opacity-60 grayscale bg-slate-50"
              )}>
                <CardHeader className="pb-6 text-center space-y-4 pt-8">
                  <div className="flex justify-center mb-2">
                     {isWinner ? (
                       <Badge className="bg-orange-600 border-none font-black text-[9px] uppercase tracking-[0.2em] px-4 py-1.5 rounded-full shadow-lg">
                         ⭐ OPCIÓN RECOMENDADA
                       </Badge>
                     ) : isBlocked ? (
                  ...
                  <div className="flex flex-col items-center gap-2">
                      <div className={cn("p-4 rounded-2xl shadow-inner", isWinner ? "bg-orange-100 text-orange-600" : "bg-slate-100 text-slate-400")}>
                          <Icon size={32} />
                      </div>
