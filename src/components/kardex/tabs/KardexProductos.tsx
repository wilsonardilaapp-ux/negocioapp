...
import type { ItemInventario, EstadoStock, TipoItem } from '@/types/kardex.types';
...
export default function KardexProductos({ items }: KardexProductosProps) {
        ...
        <Card>
            <CardHeader>
                <div className="flex justify-between items-center">
                    ...
                    <Button><PlusCircle className="mr-2 h-4 w-4" /> Nuevo Ítem</Button>
                </div>
            </CardHeader>
            <CardContent>
                ...
                <div className="rounded-md border">
                    <Table><TableHeader><TableRow><TableHead>Código</TableHead><TableHead>Nombre</TableHead><TableHead>Tipo</TableHead><TableHead>Categoría</TableHead><TableHead>Unidad</TableHead><TableHead>Stock Actual</TableHead><TableHead>Stock Mín.</TableHead><TableHead>Costo Unit.</TableHead><TableHead>Valor Total</TableHead><TableHead>Estado</TableHead></TableRow></TableHeader><TableBody>
                        ...
                        )) : (<TableRow><TableCell colSpan={10} className="h-24 text-center">No se encontraron ítems.</TableCell></TableRow>)}
                    </TableBody></Table>
                </div>
            </CardContent>
        </Card>
